        ...
        <div>
            ...
            <div>
                <div>
                    ...
                    <asp:GridView ID="edgeoftomorrowfilm"  CssClass="mGrid" Font-Bold="true" runat="server" CellPadding="15" CellSpacing="15">
                    </asp:GridView>
                    <br /><br />
                    <asp:Label ID="edgeoftomorrowtext2" runat="server" Font-Size="Medium" Text="   Actors Details Are:"
                        ForeColor="LightSkyBlue"></asp:Label>
                    <asp:GridView ID="edgeoftomorrowdata"  CssClass="mGrid" Font-Bold="true" runat="server" CellPadding="15" CellSpacing="15">
                    </asp:GridView>
                </div>
            </div>
        </div>
