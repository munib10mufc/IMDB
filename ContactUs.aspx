 ...
 */::-moz-focus-inner
        ...
        <body>
            ...
            <fieldset class="contact-inner">
                ...
                <%--<p class="contact-submit" onclick="javascript:redirect()">
                    <input type="submit" value="Send Message" >
                    --%><a href="Home.aspx" onclick="javascript:redirect()">
                   <h1><asp:Label ID="submitbutton" runat="server" Text="Submit" ></asp:Label>
                   </a></h1>
                <%--</p>--%>
